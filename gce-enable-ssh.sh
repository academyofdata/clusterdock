...
# gcloud compute ssh ${INSTANCE} --zone ${ZONE} --command "wget -qO- https://raw.githubusercontent.com/academyofdata/clusterdock/master/gce-enable-ssh.sh | bash -s hduser"
