...
wget -q https://raw.githubusercontent.com/academyofdata/clusterdock/master/etl.scala
#runs spark-shell providing the script as input
HADOOP_USER_NAME=spark spark-shell --packages com.databricks:spark-csv_2.10:1.5.0 com.databricks:spark-avro_2.10:3.2.0 -i etl.scala 
